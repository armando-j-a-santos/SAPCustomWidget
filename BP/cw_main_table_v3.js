(function() {
    ...
    function loadthis(that, changedProperties) {
        ...
        div2.innerHTML = '<script id="oView' + widgetName + '" name="oView' + widgetName + '" type="sapui5/xmlview"><mvc:View controllerName="myView.Template" xmlns:core="sap.ui.core" xmlns:mvc="sap.ui.core.mvc" xmlns="sap.ui.table" xmlns="sap.ui.commons"><TreeTable id="tbl" rows="10"></TreeTable></mvc:View></script>';               
